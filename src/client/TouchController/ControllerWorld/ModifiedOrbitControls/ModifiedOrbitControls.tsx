// Modifies OrbitControls to ignore multitouch
...
class ModifiedOrbitControls extends EventDispatcher {
...
class MapControls extends ModifiedOrbitControls {
  constructor(object: PerspectiveCamera | OrthographicCamera, domElement?: HTMLElement) {
...
export { ModifiedOrbitControls, MapControls }